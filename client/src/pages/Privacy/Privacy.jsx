  ...
  return (
    <div>
      ...
      <p>
        ...
        website MovieReviewer (the "Site") and any associated services (the
        "Services").
      </p>

      <h2>Information We Collect</h2>
      <p>
        <strong>Personal Information:</strong> When you use our Site or
        Services, we may collect certain personally identifiable information,
        such as your name, email address, postal address, phone number, and any
        other information you provide to us.
      </p>
      <p>
        <strong>Usage Information:</strong> We may also collect information
        about how you interact with our Site and Services, such as your IP
        address, browser type, device type, operating system, and other usage
        information.
      </p>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            To analyze usage and trends and optimize the performance of our Site
            and Services.
          </li>
          <li>
      ...
      <p>
        ...
        <ul>
          <li>
            ...
            operating our Site and Services, performing functions on our behalf,
            and providing services to you.
          </li>
          <li>
            With our affiliates and subsidiaries for internal business purposes.
          </li>
          <li>
      ...
      <p>
        ...
        including the right to access, correct, amend, or delete your
